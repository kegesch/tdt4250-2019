...
import programmes.SemesterType;

/**
 * This is the item provider adapter for a {@link programmes.Semester} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SemesterItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProgrammesPackage.Literals.SEMESTER__COURSES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProgrammesPackage.Literals.SEMESTER__SEMESTER_TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProgrammesPackage.Literals.SEMESTER__YEAR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		SemesterType labelValue = ((Semester)object).getSemesterType();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Semester.class)) {
			case ProgrammesPackage.SEMESTER__SEMESTER_TYPE:
			case ProgrammesPackage.SEMESTER__YEAR:
