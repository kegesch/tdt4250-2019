...
public class ProgrammesPackageImpl extends EPackageImpl implements ProgrammesPackage {
	 ...
	 */
	@Override
	public EReference getProgramme_CourseGroups() {
	 ...
	 */
	@Override
	public EAttribute getCourseGroup_CoursesType() {
	...
	public void createPackageContents() {
		...
		createEReference(programmeEClass, PROGRAMME__COURSE_GROUPS);
		...
		createEAttribute(courseGroupEClass, COURSE_GROUP__COURSES_TYPE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCourse_Level(), this.getStudyLevel(), "level", null, 0, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getProgramme_ProgrammeSemester(), this.getSemester(), this.getSemester_Programme(), "programmeSemester", null, 0, -1, Programme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProgramme_CourseGroups(), this.getCourseGroup(), null, "courseGroups", null, 0, -1, Programme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSpecialization_ChosenIn(), this.getSemester(), null, "chosenIn", null, 1, 1, Specialization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(semesterEClass, Semester.class, "Semester", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSemester_Programme(), this.getProgramme(), this.getProgramme_ProgrammeSemester(), "programme", null, 1, 1, Semester.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSemester_SemesterType(), this.getSemesterType(), "semesterType", null, 0, 1, Semester.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCourseGroup_CoursesType(), this.getCourseType(), "coursesType", null, 0, 1, CourseGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getUniversity_StudyProgrammes(), this.getProgramme(), null, "studyProgrammes", null, 0, -1, University.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(studyLevelEEnum, StudyLevel.FIRST_YEAR);
		addEEnumLiteral(studyLevelEEnum, StudyLevel.SECOND_YEAR);
		addEEnumLiteral(studyLevelEEnum, StudyLevel.THIRD_YEAR);
		addEEnumLiteral(studyLevelEEnum, StudyLevel.SECOND_DEGREE);
		addEEnumLiteral(studyLevelEEnum, StudyLevel.POST_GRAD);
